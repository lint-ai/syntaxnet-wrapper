...
5\ttest\t_\t_\t_\tGender=Masc|Number=Sing|fPOS=NOUN++\t0\t_\t_\t_\n\n"""
        ...
        self.assertEqual(
            result, send_input(test_morpho_analyzer, "Cet input est un test")
        )
    ...
    def test_morpho_sentence(self):
        ...
        self.assertEqual(
            result,
            SyntaxNetWrapperSubprocess(language='French').morpho_sentence(
                input_sentence
            ),
        )
    ...
    def test_morpho_sentences(self):
        ...
        self.assertEqual(
            results,
            SyntaxNetWrapperSubprocess(language='French').morpho_sentences(
                input_sentences
            ),
        )
    ...
    def test_tag_sentence(self):
        ...
        self.assertEqual(
            result,
            SyntaxNetWrapperSubprocess(language='French').tag_sentence(input_sentence),
        )
    ...
    def test_tag_sentences(self):
        ...
        self.assertEqual(
            result,
            SyntaxNetWrapperSubprocess(language='French').tag_sentences(
                input_sentences
            ),
        )
    ...
    def test_parse_sentence(self):
        ...
        self.assertEqual(
            result,
            SyntaxNetWrapperSubprocess(language='French').parse_sentence(
                input_sentence
            ),
        )
    ...
    def test_parse_sentences(self):
        ...
        self.assertEqual(
            result,
            SyntaxNetWrapperSubprocess(language='French').parse_sentences(
                input_sentences
            ),
        )
    ...
    def test_parse_sentence_en(self):
        ...
        self.assertEqual(
            result, SyntaxNetWrapperSubprocess().parse_sentence(input_sentence)
        )
