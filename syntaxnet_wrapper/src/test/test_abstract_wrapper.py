...
class TestAbstractWrapper(TestCase):
        ...
        result = {
            1: dict(
                [
                    ('index', 1),
                    ('token', u'Cette'),
                    ('feats', u'Gender=Fem|Number=Sing|fPOS=DET++'),
                ]
            ),
            2: dict(
                [
                    ('index', 2),
                    ('token', u'phrase'),
                    ('feats', u'Gender=Fem|Number=Sing|fPOS=NOUN++'),
                ]
            ),
            3: dict(
                [
                    ...
                    (
                        'feats',
                        u'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|fPOS=VERB++',
                    ),
                ]
            ),
            4: dict(
                [
                    ...
                    (
                        'feats',
                        u'Definite=Ind|Gender=Masc|Number=Sing|PronType=Dem|fPOS=DET++',
                    ),
                ]
            ),
            5: dict(
                [
                    ('index', 5),
                    ('token', u'test'),
                    ('feats', u'Gender=Masc|Number=Sing|fPOS=NOUN++'),
                ]
            ),
        }
        self.assertEqual(
            result,
            AbstractSyntaxNetWrapper(language='French').transform_morpho(input_morpho),
        )
    ...
    def test_transform_tag(self):
        ...
        self.assertEqual(
            result, AbstractSyntaxNetWrapper(language='French').transform_tag(input_tag)
        )
    ...
    def test_transform_dependency(self):
            ...
            },
            {
                ...
                'vertice': {
                    ...
                    'attributes': {
                        ...
                        'parent': 5,
                        'pos': u'_',
                        'feats': u'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin|fPOS=VERB++',
                        'label': u'VERB',
                    },
                },
            },
            {
                ...
                'vertice': {
                    ...
                    'attributes': {
                        ...
                        'parent': 5,
                        'pos': u'_',
                        'feats': u'Definite=Ind|Gender=Masc|Number=Sing|PronType=Dem|fPOS=DET++',
                        'label': u'DET',
                    },
                },
            },
        ...
        self.assertEqual(
            result,
            list(
                AbstractSyntaxNetWrapper(language='French')
                .transform_dependency(input_dependency)
                .serialize()
            ),
        )
